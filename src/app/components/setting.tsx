...
const Setting = () => {
    ...
    const [translationCacheCount, setTranslationCacheCount] = useState<number>(0);
    const [polishCacheCount, setPolishCacheCount] = useState<number>(0);
    ...
    useEffect(() => {
        const handleReceiveLocalStorage = (objs: { key: StorageKey; value: any }[]) => {
            objs.forEach(({ key, value }) => {
                const updateMap = {
                    ...
                    [StorageKey.TranslationCache]: () => setTranslationCacheCount(typeof value === 'object' && value ? Object.keys(value).length : 0),
                    [StorageKey.PolishCache]: () => setPolishCacheCount(typeof value === 'object' && value ? Object.keys(value).length : 0),
                };
    ...
    return (
        <Block className="settings-container">
                        ...
                        <Block className="tab-content tab-scroll">
                            <div className="stat-list">
                                <div className="stat-item">
                                    <LabelSmall marginTop={0} marginBottom={0} style={{ color: 'var(--text)', fontWeight: 500 }}>Translation cache</LabelSmall>
                                    <LabelSmall marginTop={0} marginBottom={0} style={{ color: 'var(--text)', fontWeight: 600 }}>{translationCacheCount}</LabelSmall>
                                </div>
                                <div className="stat-divider"></div>
                                <div className="stat-item">
                                    <LabelSmall marginTop={0} marginBottom={0} style={{ color: 'var(--text)', fontWeight: 500 }}>Polish cache</LabelSmall>
                                    <LabelSmall marginTop={0} marginBottom={0} style={{ color: 'var(--text)', fontWeight: 600 }}>{polishCacheCount}</LabelSmall>
                                </div>
                            </div>
                            <Button kind={KIND.secondary} onClick={handleClearCache} overrides={{ BaseButton: { style: { width: '100%' } } }}>
                                Clear Cache
                            </Button>
                        </Block>
                    </Tab>
            ...
            <Block className="footer-actions">
