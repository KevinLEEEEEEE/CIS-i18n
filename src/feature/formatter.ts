...
const typographyDictionary = {
    "特大标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Semibold" }, fontSize: 30, lineHeight: 46, language: Language.ZH, platform: Platform.Desktop, styleKey: 'baace18851d4410b290e76e4030a6c43894015b7' },
    "一级标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Semibold" }, fontSize: 24, lineHeight: 36, language: Language.ZH, platform: Platform.Desktop, styleKey: '84b11a3514fcc6331fd7b22faaf6b0e1e479a60c' },
    "二级标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Medium" }, fontSize: 20, lineHeight: 30, language: Language.ZH, platform: Platform.Desktop, styleKey: '815d93ed9bfd4457154e8938482e258c29ef97dd' },
    "三级标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Medium" }, fontSize: 18, lineHeight: 28, language: Language.ZH, platform: Platform.Desktop, styleKey: '357161d8af91a6c343195f3a85e437bd1ae7428a' },
    "四级标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Medium" }, fontSize: 16, lineHeight: 24, language: Language.ZH, platform: Platform.Desktop, styleKey: 'dc094b69f79fb32793a63a94ebfa0bee11c680ee' },
    "五级标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Regular" }, fontSize: 16, lineHeight: 24, language: Language.ZH, platform: Platform.Desktop, styleKey: 'b969aea446b6cdb04d9a22f74016d84804bd04ea' },
    "辅助标题_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Medium" }, fontSize: 14, lineHeight: 22, language: Language.ZH, platform: Platform.Desktop, styleKey: '633417d53d1f6aaf5a25836c3dfbb7865cc26901' },
    "正文_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Regular" }, fontSize: 14, lineHeight: 22, language: Language.ZH, platform: Platform.Desktop, styleKey: 'a619584c8b84081754e0d0548cc02918bb2608ae' },
    "正文辅助_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Regular" }, fontSize: 12, lineHeight: 20, language: Language.ZH, platform: Platform.Desktop, styleKey: '800d06fe6c96efcf63c147c3908ac723663ef12a' },
    "辅助_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Medium" }, fontSize: 12, lineHeight: 20, language: Language.ZH, platform: Platform.Desktop, styleKey: '08d5d98e3b3457af595d34e5701aa5f15b7d6bdf' },
    "小辅助_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Medium" }, fontSize: 10, lineHeight: 16, language: Language.EN, platform: Platform.Desktop, styleKey: 'a468d88d9821a71292ff1248f343718729f385ee' },
    "最小辅助_Desktop_ZH": { fontName: { family: "PingFang SC", style: "Regular" }, fontSize: 10, lineHeight: 16, language: Language.EN, platform: Platform.Desktop, styleKey: '3e7b95748455839143dce3a39f2c08ce24cca648' },

    "Title-0_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Semibold" }, fontSize: 30, lineHeight: 46, language: Language.EN, platform: Platform.Desktop, styleKey: 'c94c00e250f2f32a1e99b8a4fb5f847d980c93f3' },
    "Title-1_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Semibold" }, fontSize: 24, lineHeight: 36, language: Language.EN, platform: Platform.Desktop, styleKey: '493f65cc7355e1dfdb902d3ae2bb21931d898e9c' },
    "Title-2_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Medium" }, fontSize: 20, lineHeight: 30, language: Language.EN, platform: Platform.Desktop, styleKey: 'c272b336db56ff1ee5e67415b197fcdce26bf8e5' },
    "Title-3_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Medium" }, fontSize: 18, lineHeight: 28, language: Language.EN, platform: Platform.Desktop, styleKey: 'f5ec4aa020fa8adcd2dd3d3422d75a0f40b9a602' },
    "Title-4_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Medium" }, fontSize: 16, lineHeight: 24, language: Language.EN, platform: Platform.Desktop, styleKey: 'fef0d8335452173953a6fe8309175fddb989c0d1' },
    "Title-5_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Regular" }, fontSize: 16, lineHeight: 24, language: Language.EN, platform: Platform.Desktop, styleKey: '2fb9fc4d80b17fbe299d8fad71ade84f0c8853ca' },
    "Headline_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Medium" }, fontSize: 14, lineHeight: 22, language: Language.EN, platform: Platform.Desktop, styleKey: 'effac6f1285c0efcbcdfd9fac1295bc4fbcf82bb' },
    "Body-0_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Regular" }, fontSize: 14, lineHeight: 22, language: Language.EN, platform: Platform.Desktop, styleKey: 'bd0fe524af75554cb26f336c6916c3100be75f2d' },
    "Body-2_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Regular" }, fontSize: 12, lineHeight: 20, language: Language.EN, platform: Platform.Desktop, styleKey: '2d7121c34523ead5779a21d8ccdfb215b5c10ac3' },
    "Caption-0_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Medium" }, fontSize: 12, lineHeight: 20, language: Language.EN, platform: Platform.Desktop, styleKey: '3008f7356e60db42a85d8bcaf3be8674d36dc88e' },
    "Caption-1_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Medium" }, fontSize: 10, lineHeight: 16, language: Language.EN, platform: Platform.Desktop, styleKey: '74933d4d09d0c53610005529b169ce645707cb85' },
    "Caption-3_Desktop_EN": { fontName: { family: "SF Pro Text", style: "Regular" }, fontSize: 10, lineHeight: 16, language: Language.EN, platform: Platform.Desktop, styleKey: '3aa3ee2538536526e5083d46e57a82552dadde45' },
